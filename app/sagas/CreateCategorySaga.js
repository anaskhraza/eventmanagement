...
import { createCategory, getAllCategories } from "../../api/methods/Categories";
...
export default function* createCategorySync(action) {
  let response;
  try {
    //console.log("action -> ", action);
    response = yield call(createCategory, action.data);
