...
router.get("/orders", productController.fetchAllOrderedProducts);
...
router.delete(
  ...
  productController.deleteBookingProducts
);
...
router.post(
  "/createDraftProducts",
  productController.createDraftBookingProducts
);
router.delete(
  "/deleteDraftProducts",
  productController.deleteDraftBookingProducts
);
